...
const customPalettes = {
    ...
    gradiantPrimary: generatePalette('#EB2026'),
    gradiantAccent: generatePalette('#EFB207'),
    gradiantSecondary: generatePalette('#5B36BF'),
    gradiantTertiary: generatePalette('#FFC107'),
};
...
const themes = {
    ...
    brand: {
        primary: customPalettes.gradiantPrimary,
        accent: customPalettes.gradiantAccent,
    },
    teal: {
        primary: {
            ...colors.teal,
